  ...
  return (
    <div>
      <div className='abouthead'>
        <p data-aos="fade-left" data-aos-duration="700">About Us</p>
        <p data-aos="zoom-in-down" data-aos-duration="2000" className='container'>
        ...
        <p data-aos="fade-left" data-aos-duration="2300">Domains We Offer</p>
      </div>

      <div className='container' id='domains'>
        <div className='row'>
          <div class='col-md-6 col-lg-4'>
            <div data-aos="zoom-in" data-aos-duration="500" className='feature-block'>
              <img
          ...
          <div class='col-md-6 col-lg-4'>
            <div data-aos="zoom-in" data-aos-duration="1600" className='feature-block'>
              <img
          ...
          <div class='col-md-6 col-lg-4'>
            <div data-aos="zoom-in" data-aos-duration="2500"className='feature-block'>
              <img
          ...
          <div class='col-md-6 col-lg-4'>
            <div  data-aos="zoom-in" data-aos-duration="2900" className='feature-block'>
              <img
                src={web}
                className='img-fluid'
                height='120px'
